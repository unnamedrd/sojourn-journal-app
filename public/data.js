...
const travelItem = [
  ...
  },
  {
    ...
    end_date: "June 2021",
    description:
      "Near the UW campus, there are kayak rentals. Make sure to go on a sunny day. Summers in the Pacific Northwest are gorgeous, so make sure that you go during that time. After working up an appetite go to University Ave and grab a quick bite at any one of the restuarants. These places cater to the university crowd so there's a variety  of food at a price point that works for everyone",
  },
  ...
  },
  {
    ...
    end_date: "Oct 2021",
    description:
      "Here's the truth, Marrakesh isn't for the faint of heart. Tourists often flock to the beautiful Riads in the center of the city and then step outside to be overwhelmed by the chaos of the city and the dusty, dry desert. But if you're an adventurer that you'll appreciate the challenges that the city offers in learning how to bargain with the shop keepers, balancing tourist instincts while remaining respectful of the locals, immersing yourself in traditions like tea and hammam",
  },
];
